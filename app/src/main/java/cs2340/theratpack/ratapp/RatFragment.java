...
public class RatFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            int key = getArguments().getInt(ARG_ITEM_ID);
            Log.d("MYAPP", "Opening details for " + key);
            ratSighting = Model.INSTANCE.findRatById(key);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("MYAPP", "About to set data");

        //Show the data in a TextView
        if (ratSighting != null) {
            Log.d("MYAPP", "About to set key");
            ((TextView) rootView.findViewById(R.id.id2)).setText("" + ratSighting.getUniqueKey());
            Log.d("MYAPP", "Getting ready to set Created Date");
            ...
            Log.d("MYAPP", "Getting ready to set address");
